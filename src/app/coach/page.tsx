...
export default function CoachPage() {
  ...
  return (
    <PageTransition>
      ...
      <main className="flex-1 min-h-0 overflow-hidden p-4 lg:p-6 bg-muted/40">
        <div ref={containerRef} className="mx-auto max-w-7xl h-full">
          {/* Mobile: Stack vertically, Desktop: Side by side with resize */}
          <div className="flex flex-col lg:flex-row h-full gap-6 lg:gap-0 overflow-hidden">
            {/* Chat Card */}
            <div
